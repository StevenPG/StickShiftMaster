        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <button className="auto-navy hover:auto-orange transition-colors text-sm">
                Tutorial
              </button>
              <button className="auto-navy hover:auto-orange transition-colors text-sm">
                Learn More
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-6 text-sm">
              <a href="#" className="hover:auto-orange transition-colors">About</a>
              <a href="#" className="hover:auto-orange transition-colors">Tutorial</a>
              <a href="#" className="hover:auto-orange transition-colors">FAQ</a>
              <a href="#" className="hover:auto-orange transition-colors">Contact</a>
            </div>
          </div>
        </div>
      </footer>
